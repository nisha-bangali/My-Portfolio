        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a
                href="#projects"
                className="md:px-6 py-3 px-4 rounded-lg bg-blue-500 text-white font-semibold shadow hover:bg-blue-600 transition"
              >
                View My Work
              </a>
              <a
                href="#contact"
                className="px-6 py-3 rounded-lg border-2 border-blue-500 dark:border-blue-400 text-blue-500 dark:text-blue-400 font-semibold hover:bg-blue-500 hover:text-white dark:hover:bg-blue-400 dark:hover:text-gray-900 transition"
              >
                Contact Me
              </a>
            </div>
